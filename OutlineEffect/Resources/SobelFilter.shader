Shader "Unlit/SobelFilter"
{
	Properties 
	{
        ...
        _ColorOverrideTex ("Color override texture", 2D) = "black" {}
	...
	SubShader 
	{
		...
		Pass
		{
            ...
            TEXTURE2D(_ColorOverrideTex);
            SAMPLER(sampler_ColorOverrideTex);
            ...
            half4 frag (Varyings input) : SV_Target 
            {
                ...
                half4 overrideCol = SAMPLE_TEXTURE2D(_ColorOverrideTex, sampler_ColorOverrideTex, input.uv);
                return col * s + overrideCol * (1 - s);
#endif
            }
